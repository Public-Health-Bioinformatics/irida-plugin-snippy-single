...
public class SnippySinglePluginUpdaterTest {
    private String WORKFLOW_NAME = "snippy-single";
    private String WORKFLOW_VERSION = "0.1.0";

    private SnippySinglePluginUpdater updater;
    ...
    public void setUp() throws IridaWorkflowException {
        ...
        updater = new SnippySinglePluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService);
