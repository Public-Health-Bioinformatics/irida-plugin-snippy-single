 ...
 */
public class SnippySinglePluginUpdater implements AnalysisSampleUpdater {
	...
	/**
	 * Builds a new {@link SnippySinglePluginUpdater} with the given services.
	 * 
	 ...
	 */
	public SnippySinglePluginUpdater(MetadataTemplateService metadataTemplateService, SampleService sampleService,
	...
	public AnalysisType getAnalysisType() {
		return SnippySingleSinglePlugin.SNIPPY_SINGLE;
	}
}
